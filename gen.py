...
textgen = textgenrnn('./tfModels/neuro_weights.hdf5', vocab_path='./tfModels/neuro_vocab.json',
config_path='./tfModels/neuro_config.json')
...
def draw_pastell(nx=900, ny=1600, CL=180, rshift=3):
    ...
    with db_session():
        ...
        text=textgen.generate(temperature=0.2, return_as_list=True)[0]
        ),
